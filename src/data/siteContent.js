...
window.siteContent = {
  ...
  lastGame: {
    ...
    result: "win",
    recap:
      "Fall 2026 is officially open, and it opened clean: the Glizzies shut out the Salt Shakers 4-0 on the road at Mammoth Ice Center's South Rink. A retooled lineup — three fresh nameplates and a new keeper now wearing the MEAT SHIELD crease — didn't allow a single goal in the debut. Four for, zero against, and a signature statement to start the season. Next up is a receipts game: the Gnarwhalers, who beat the Glizzies 0-4 back in May, come calling on August 5.",
    momentOfGame:
      "The final horn — Fall 2026's opener ends as a shutout, 4-0 over the Salt Shakers.",
    threeStars: [
      { name: "Utah Glizzies — full 60 minutes, zero goals allowed on the road", star: 1 },
    ],
  },
    playerSpotlight: {
    name: "Ian Penders",
  ...
  hypeMeter: {
    level: 0,
    label: "Receipts Game Hype",
    reason: "1-0 and rolling. The Glizzies open Fall 2026 with a shutout, and next up is the Gnarwhalers — the same team that beat us 0-4 back in May. Every click gets the bench closer to full mustard pressure for the rematch.",
    gameWeek: "August 5 @ Gnarwhalers",
    hypeGoal: 1000,
    hypeApiBase: "https://countapi.mileshilliard.com/api/v1",
    hypeApiKey: "utahglizzies-fall2026-week2-gnarwhalers",
    hypeStorageKey: "utah-glizzies-fall2026-week2-hype-clicks",
  },
  seasonStats: {
    source: "Fall 2026 season — 1-0-0 after the July 29 win over Salt Shakers",
    season: "Fall 2026",
    gamesPlayed: 1,
    wins: 1,
    losses: 0,
    ...
    matchup: {
    title: "Receipts Due: Gnarwhalers Come to Collect",
    threatLevel: "Revenge Game",
    playerToWatch: "Gnarwhalers — the last team to shut the Glizzies out",
    opponent: "Gnarwhalers",
    record: "Gnarwhalers: won the last meeting 4-0 (May 2026, South Rink)",
    storyline:
      "The Glizzies open 1-0-0 after a season-opening shutout of the Salt Shakers, and the next test is personal. The Gnarwhalers are the last team to beat the Glizzies at their own game — a 4-0 shutout back in May. Fall 2026's new-look lineup gets a shot to even the receipts on August 5, puck drop 11:15 PM on the South Rink.",
    opponentBreakdown: [
      ["Last meeting", "Gnarwhalers won 4-0 at South Rink in May 2026 — the same scoreline the Glizzies just handed the Salt Shakers."],
      ["Current form", "Glizzies open Fall 2026 at 1-0-0 with a shutout of their own, four goals for and none against."],
      ["The rematch", "August 5, 11:15 PM, South Rink. Game two of eleven."],
    ],
    opponentStats: [
      "Next game: August 5 at 11:15 PM on the South Rink at Utah Mammoth Ice Center.",
      "Glizzies record: 1-0-0, 4 goals for, 0 against.",
      "Last meeting: Gnarwhalers 4, Glizzies 0 (May 2026).",
      "Returning core: GLIZ GOD, GLIZZNASTY, A. FROMAN, J. CHESTNUT and the rest of the spring crew are back.",
    ],
    keys: [
      "Answer the May result — this is the same scoreline the Glizzies just handed someone else.",
      "Keep feeding the new-look lineup touches; MICRO GLIZZ, WIENER WRANGLER and GLIZZIN' STEW are three games into finding chemistry.",
      "Protect the new MEAT SHIELD's shutout streak as long as it'll go.",
      "GLIZZNASTY carried the offense last season — feed him early and often.",
      "Two games into eleven. Keep the grill lit and the streak alive.",
    ],
  },
    opponentChirps: [
    {
