...
window.siteContent = {
  ...
  siteLinks: [
    ...
    ["Matchup", "index.html#matchup", "This week's playoff briefing, keys to the game, and Saucer Kings scouting notes."],
  ...
  schedule: [
    ...
    { date: "2026-06-11", displayDate: "Jun 11", time: "10:45 PM", opponent: "The North", label: "@ The North", rink: "North Rink", status: "final", glizziesScore: 3, opponentScore: 4, result: "loss" },
  ...
  lastGame: {
    ...
    result: "loss",
    recap:
      "The Glizzies led 3-1 heading into the third and then watched The North claw back two late goals to tie it — one of which was an own goal courtesy of Captain Sir Glizzington III, who picked the worst possible moment to get creative. Overtime 3v3 produced nothing. The shootout went seven rounds and The North converted more. Hayden Rathmell had 2 goals and an assist. JP Gould scored the other. Meat Shield faced 9 shots to the Glizzies’ 25. A gut punch loss made worse by the fact that the Captain personally assisted in the collapse.",
    momentOfGame:
      "Captain Sir Glizzington III depositing a puck into his own net in the third period, personally reigniting The North’s belief that they were in a hockey game. The Captain has been informed that own goals do not count toward his stat line. He was not comforted by this.",
    threeStars: [
      { name: "Hayden Rathmell (GLIZ GOD)", star: 1 },
      { name: "JP Gould (GREASE MISSILE)", star: 2 },
  ...
  hypeMeter: {
    level: 0,
    label: "Bounce Back Hype",
    reason: "We were up 3-1. We know. Reset the meter. Next game needs the full bench energy.",
    gameWeek: "June 18 vs Saucer Kings",
    hypeGoal: 1000,
    hypeApiBase: "https://countapi.mileshilliard.com/api/v1",
    hypeApiKey: "utahglizzies-2026-playoff-jun18",
    hypeStorageKey: "utah-glizzies-playoff-hype-clicks",
  },
  seasonStats: {
    source: "GameSheetStats D League standings, refreshed June 6, 2026",
    gamesPlayed: 12,
    wins: 6,
    losses: 5,
    shootoutLosses: 1,
    ...
    matchup: {
    title: "Playoff Round Three: Do Not Blow This One",
    threatLevel: "Elevated Receipts Energy",
    playerToWatch: "Dennis Sampson",
    opponent: "Saucer Kings",
    record: "Saucer Kings: 2-0-0, 3.54 GF/game, 4.31 GA/game, PP 30.8%, PK 64.3%",
    storyline:
      "The Glizzies and the Saucer Kings have history. Back on April 10th, the Glizzies held a 4-1 lead and donated it, lost in a shootout, and spent the rest of the regular season thinking about it. Now they meet again in the playoffs. The Saucer Kings are 2-0 in the tournament. Their PP is 30.8% — the highest danger stat on this card. Dennis Sampson has 7 goals. Chad Moore is at 11 points. Ian Penders leads all assists with 7. Hayden Rathmell leads the Glizzies with 13 points. The Glizzies need to close out a lead this time. No 3v3. No shootout. Sixty minutes.",
    opponentBreakdown: [
      ["Top scorer", "Dennis Sampson has 7 goals — tied with Jared Aida for the tournament lead. Make him work for every inch of ice."],
      ["Point machine", "Chad Moore leads Saucer Kings with 11 points. Disrupting Moore disrupts everything downstream."],
      ["Powerplay danger", "30.8% powerplay is a warning. Stay out of the box. Every penalty is a loaded gun handed to the wrong team."],
      ["Their weakness", "64.3% PK and 4.31 goals against. They can be scored on. Get leads and hold them this time."],
    ],
    opponentStats: [
      "Next up: Saucer Kings, June 18 at 9:15 PM on South Rink.",
      "Saucer Kings: 2-0-0, 3.54 GF/game, 4.31 GA/game.",
      "Saucer Kings PP: 30.8% — highest danger stat on the card. Stay disciplined.",
      "Saucer Kings PK: 64.3%. Get on the power play early and cash it.",
      "Dennis Sampson: 7 goals. Chad Moore: 11 points. Ian Penders leads all assists with 7A.",
      "Hayden Rathmell leads Glizzies with 13 PTS.",
      "Head to head: Glizzies blew a 4-1 lead Apr 10 and lost in a shootout. That does not happen twice.",
    ],
    keys: [
      "Protect the lead. The Apr 10 receipt is in everyone\'s pocket. A lead means nothing if the third period gives it back.",
      "Stay out of the box. Their 30.8% powerplay will convert. Every penalty is a gift nobody asked for.",
      "Get on Sampson early. Seven goals means he is comfortable. Make him uncomfortable from puck drop.",
      "Disrupt Moore before he sets up Sampson. Neutralize the engine, stall the offense.",
      "Close it out in regulation. No 3v3. No shootout. Sixty minutes of Glizzy hockey and go home with the win.",
    ],
  },
    opponentChirps: [
    {
      playerName: "Dennis Sampson",
      number: "—",
      moment: "Seven Goals",
      lines: [
        "Sampson has seven goals. Jared Aida also has seven and did not blow a 4-1 lead doing it.",
        "Dennis, seven goals in a tournament is impressive. The Glizzies need you to stop now.",
        "Seven goals means he is comfortable. The Glizzies specialize in making comfortable people uncomfortable.",
      ],
    },
    {
      playerName: "Chad Moore",
      number: "—",
      moment: "Eleven Points",
      lines: [
        "Moore has eleven points. Hayden Rathmell has thirteen and a two-goal night that still does not feel like enough.",
        "Chad Moore is the engine. Engines stall. Ask anyone who drove home from the Apr 10 game.",
        "Eleven points means Moore touches everything. That arrangement ends Thursday.",
      ],
    },
    {
      playerName: "Saucer Kings",
      number: "—",
      moment: "30.8% Powerplay",
      lines: [
        "Thirty point eight percent powerplay. That is not a stat, that is a threat assessment.",
        "Their powerplay is 30.8%. The Glizzies\' response is simple: do not take penalties.",
        "Every Glizzy penalty Thursday is basically handing Sampson a signed permission slip to score.",
      ],
    },
    {
      playerName: "Saucer Kings",
      number: "—",
      moment: "Apr 10 Receipt",
      lines: [
        "The Glizzies were up 4-1 in April. The Saucer Kings know. The Glizzies definitely know.",
        "That 4-1 lead in April was a learning experience. Thursday is the exam.",
        "Some teams blow leads once. The Glizzies are not doing it twice. Especially not to these guys.",
      ],
    },
  ],
    players: [
    { name: "Andrew Herrin", number: "6", nameplate: "A. FROMAN", position: "Forward", photo: "", bio: "Abe Froman. Sausage King of Chicago. Do not ask how he got the reservation.", stats: { gp: 11, g: 1, a: 2, pts: 3, pim: 2 }, instagram: "", nickname: "Sausage King of Chicago" },
    ...
    { name: "James Pope", number: "9", nameplate: "JDAWG", position: "Forward", photo: "", bio: "Points by generosity. Very diplomatic stat line.", stats: { gp: 11, g: 1, a: 2, pts: 3, pim: 0 }, instagram: "", nickname: "JDawg" },
    ...
    { name: "Ian Penders", number: "5", nameplate: "LIL' SMOKIES", position: "Forward", photo: "", bio: "Assist machine with a perfect shootout percentage cameo.", stats: { gp: 10, g: 1, a: 5, pts: 6, pim: 4 }, instagram: "", nickname: "Lil' Smokies" },
    ...
    { name: "Matt Zimmerman", number: "95", nameplate: "ZIMMY CASINO", position: "Forward", photo: "", bio: "Perfectly balanced mini combo meal.", stats: { gp: 9, g: 1, a: 1, pts: 2, pim: 0 }, instagram: "", nickname: "Zimmy Casino" },
    { name: "Wyatt McNeil", number: "7", nameplate: "GLIZZNASTY", position: "Forward", photo: "", bio: "Four goals in six games. Limited edition offense, suspiciously efficient.", stats: { gp: 6, g: 4, a: 0, pts: 4, pim: 0, gwg: 1 }, instagram: "", nickname: "Glizznasty" },
