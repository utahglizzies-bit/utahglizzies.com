...
window.siteContent = {
  ...
  lastGame: {
    opponent: "Gnarwhalers",
    glizziesScore: 5,
    opponentScore: 3,
    date: "Aug 5, 2026",
    result: "win",
    recap:
      "Receipts collected: the Glizzies avenged their May 0-4 shutout loss with a 5-3 road win over the Gnarwhalers, outshot 30-26 but making every big moment count. GLIZZNASTY (Wyatt McNeil) put on a show — a fake-shot dish to A. FROMAN (Andrew Herrin) that may or may not have been on purpose set up the opening goal, a fluffer off the point snuck in with two seconds left on the first-period clock to make it 2-1, and a top-shelf snipe on a third-period power play sealed his three-point night. LIL' SMOKIES (Ian Penders) potted the game-winner in the second off a feed from GLIZZARD OF OZ (Jared Aida), with SAUCE DAWG (Devon Woodside) adding one of his own off helpers from GLIZZIN' STEW (Hunter Stewart) and WÜRSTMEISTER (Cole Embrey). MEAT SHIELD (Devin Bain) turned aside 27 of 30 shots for the win. Glizzies improve to 2-0-0 to open Fall 2026.",
    momentOfGame:
      "GLIZZNASTY's fake-shot feed to A. FROMAN for the opening goal — it looked like a shot right up until it wasn't.",
    threeStars: [
      { name: "Wyatt McNeil (GLIZZNASTY) — 2G, 1A, a receipts-game hat trick of highlights", star: 1 },
      { name: "Ian Penders (LIL' SMOKIES) — game-winning goal", star: 2 },
      { name: "Devin Bain (MEAT SHIELD) — 27 saves on 30 shots for the win", star: 3 },
    ],
  },
    playerSpotlight: {
    name: "Ian Penders",
    ...
    story:
      "Ian Penders doesn't make a lot of noise, but his stat line does. Three goals through two games to open Fall 2026, including the game-winner against the Gnarwhalers. LIL' SMOKIES is the kind of player who is everywhere on the ice and somehow never seems to be in a hurry. That combination of vision, pace, and quiet confidence is exactly what a team needs early in a new season.",
    callouts: [
      ["Bench Verdict", "The Quiet Closer"],
      ["Stat Line", "3 goals, 0 assists, 3 points through 2 games (Fall 2026)"],
  ...
  hypeMeter: {
    level: 0,
    label: "2-0 Hype",
    reason: "2-0-0 and rolling. GLIZZNASTY just dropped a 2G, 1A receipts game on the Gnarwhalers, and next up is the Zombonis at home. Every click gets the bench closer to full mustard pressure for game three.",
    gameWeek: "August 13 vs Zombonis",
    hypeGoal: 1000,
    hypeApiBase: "https://countapi.mileshilliard.com/api/v1",
    hypeApiKey: "utahglizzies-fall2026-week3-zombonis",
    hypeStorageKey: "utah-glizzies-fall2026-week3-hype-clicks",
  },
  seasonStats: {
    source: "Fall 2026 season — 2-0-0 after the August 5 win over the Gnarwhalers",
    season: "Fall 2026",
    gamesPlayed: 2,
    wins: 2,
    losses: 0,
    ...
    matchup: {
    title: "Home Ice, Full Tank: Zombonis Visit",
    threatLevel: "Season-High Confidence",
    playerToWatch: "GLIZZNASTY — riding a 3-point game into week three",
    opponent: "Zombonis",
    record: "Zombonis: lost the last meeting 4-1 (May 2026, North Rink)",
    storyline:
      "The Glizzies are 2-0-0 to open Fall 2026, having settled the books on both the Salt Shakers and the Gnarwhalers already. GLIZZNASTY (Wyatt McNeil) is fresh off a 2-goal, 1-assist night that included a fake-shot helper, a last-second fluffer, and a top-shelf snipe. Next up is the Zombonis, who the Glizzies beat 4-1 back in May, at home on the South Rink August 13.",
    opponentBreakdown: [
      ["Last meeting", "Glizzies won 4-1 at North Rink in May 2026."],
      ["Current form", "Glizzies are 2-0-0, outscoring opponents 9-3 through two games."],
      ["The rematch", "August 13, 10:00 PM, South Rink. Game three of eleven."],
    ],
    opponentStats: [
      "Next game: August 13 at 10:00 PM on the South Rink at Utah Mammoth Ice Center.",
      "Glizzies record: 2-0-0, 9 goals for, 3 against.",
      "Last meeting: Glizzies 4, Zombonis 1 (May 2026).",
      "Returning core: GLIZ GOD, GLIZZNASTY, A. FROMAN, J. CHESTNUT and the rest of the spring crew are back.",
    ],
    keys: [
      "Keep riding the hot hand — GLIZZNASTY has 3 points in the last game alone.",
      "Protect a two-game unbeaten streak against a team the Glizzies already handled once this year.",
      "Keep feeding the new-look lineup touches; MICRO GLIZZ, WIENER WRANGLER and GLIZZIN' STEW are finding their groove.",
      "MEAT SHIELD has been reliable in net — keep the shot quality down in front of him.",
      "Three games into eleven. Keep the grill lit and the streak alive.",
    ],
  },
    opponentChirps: [
    {
    ...
    players: [
    { name: "Andrew Herrin", number: "6", nameplate: "A. FROMAN", position: "Forward", photo: "", bio: "Abe Froman. Sausage King of Chicago. Fall 2026: a goal and an assist through two games — the assist on UNCLE GLIZZBURN's shorthanded goal in the opener, the goal off GLIZZNASTY's slick feed against the Gnarwhalers.", stats: { gp: 2, g: 1, a: 1, pts: 2, pim: 0 }, instagram: "", nickname: "A. Froman" },
    { name: "Devon Woodside", number: "94", nameplate: "SAUCE DAWG", position: "Forward", photo: "", bio: "Goal scorer, historically a penalty-box regular — clean sheet so far this Fall. One goal through two games.", stats: { gp: 1, g: 1, a: 0, pts: 1, pim: 0 }, instagram: "", nickname: "Sauce Dawg" },
    { name: "Chris Call", number: "24", nameplate: "J. CHESTNUT", position: "Forward", photo: "", bio: "Quietly productive, loudly inconvenient for opponents. Two games into Fall 2026, still looking for the first point on the board.", stats: { gp: 2, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "J. Chestnut" },
    { name: "Cole Embrey", number: "3", nameplate: "WÜRSTMEISTER", position: "Wing", photo: "", bio: "Still fully comfortable causing a scene. An assist through two games this Fall, setting up SAUCE DAWG's goal against the Gnarwhalers.", stats: { gp: 1, g: 0, a: 1, pts: 1, pim: 0 }, instagram: "", nickname: "Würstmeister" },
    { name: "Parker Strong", number: "17", nameplate: "SIR GLIZZINGTON III", position: "Forward", photo: "", bio: "Captain. Missed the opener, back in the lineup for the Gnarwhalers win. The forecheck absolutely files taxes early.", stats: { gp: 1, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "Sir Glizzington III" },
    ...
    { name: "James Pope", number: "9", nameplate: "JDAWG", position: "Forward", photo: "", bio: "Points by generosity. Dressed for both Fall 2026 games so far, still hunting the first point.", stats: { gp: 2, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "JDawg" },
    { name: "Brian Coburn", number: "73", nameplate: "UNCLE GLIZZBURN", position: "Forward", photo: "", bio: "Alternate captain energy confirmed early — two goals, including a shorthander, in the Fall 2026 opener.", stats: { gp: 1, g: 2, a: 0, pts: 2, pim: 0 }, instagram: "", nickname: "Uncle Glizzburn" },
    { name: "Hayden Rathmell", number: "1", nameplate: "GLIZ GOD", position: "Forward", photo: "", bio: "The spreadsheet has a personality now. An assist through two games so far this Fall — setting up UNCLE GLIZZBURN's shorthanded goal in the opener.", stats: { gp: 1, g: 0, a: 1, pts: 1, pim: 0 }, instagram: "", nickname: "Gliz God" },
    { name: "Devin Bain", number: "11", nameplate: "MEAT SHIELD", position: "Goalie", photo: "", bio: "New season, same sacred crease. Missed the opener, then made his Fall 2026 debut with 27 saves on 30 shots for the win over the Gnarwhalers.", stats: { gp: 1, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "Meat Shield" },
    { name: "Kevin Peterson", number: "22", nameplate: "GLIZZ LORD", position: "Forward", photo: "", bio: "Clean record, useful points, suspiciously professional. An assist through two games, on GLIZZNASTY's last-second power-play goal against the Gnarwhalers.", stats: { gp: 1, g: 0, a: 1, pts: 1, pim: 0 }, instagram: "", nickname: "Glizz Lord" },
    { name: "Jared Aida", number: "8", nameplate: "GLIZZARD OF OZ", position: "Forward", photo: "", bio: "The hot dog cannon remains pointed at him. An assist through two games, setting up LIL' SMOKIES' game-winner against the Gnarwhalers.", stats: { gp: 1, g: 0, a: 1, pts: 1, pim: 0 }, instagram: "", nickname: "Glizzard of Oz" },
    { name: "Ian Penders", number: "5", nameplate: "LIL' SMOKIES", position: "Forward", photo: "", bio: "A forecheck that keeps the rhythm section honest. Three goals through two games, including the game-winner against the Gnarwhalers — a hot start to Fall 2026.", stats: { gp: 2, g: 3, a: 0, pts: 3, pim: 0 }, instagram: "", nickname: "Lil' Smokies" },
    { name: "Brady Bessette", number: "26", nameplate: "DER WÜRST", position: "Forward", photo: "", bio: "Direct deposit only. Hasn't suited up yet this Fall — stat sheet on standby.", stats: { gp: 0, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "Der Würst" },
    { name: "Wyatt McNeil", number: "53", nameplate: "GLIZZNASTY", position: "Forward", photo: "", bio: "The release is a public safety concern. A 2-goal, 1-assist night against the Gnarwhalers to open his Fall 2026 season with a bang — Raw Dog of the Night honors included.", stats: { gp: 1, g: 2, a: 1, pts: 3, pim: 0 }, instagram: "", nickname: "GlizzNasty" },
    { name: "Zimmy Casino", number: "95", nameplate: "GLIZ-Z", position: "Forward", photo: "", bio: "Two games into Fall 2026, still looking for the first point on the board.", stats: { gp: 2, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "Gliz-Z" },
    ...
    { name: "Hunter Stewart", number: "10", nameplate: "GLIZZIN' STEW", position: "Forward", photo: "", bio: "New for Fall 2026. Stepped into net for a shutout win in his debut, then picked up an assist back at forward in game two — and a tripping minor to keep it honest.", stats: { gp: 2, g: 0, a: 1, pts: 1, pim: 2 }, instagram: "", nickname: "Glizzin' Stew" },
  ],
  sponsors: {
    current: [
...
rawDogOfNight: {
    ...
    honorableMention: "Whoever's guarding the blue line for the Gnarwhalers, wherever they are now",
    stats: [
      { icon: "🎯", label: "Top Shelf, No Doubt" },
      { icon: "🕐", label: "Beat The Clock By 2 Seconds" },
      { icon: "🤔", label: "Shot or Pass? Unclear." },
    ],
  },
  gameStats: {
