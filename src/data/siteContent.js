...
window.siteContent = {
  teamInfo: {
    ...
    secondaryLogo: "assets/solo_stix.png",
  ...
  schedule: [
    ...
    { date: "2026-06-25", displayDate: "Jun 25", time: "9:30 PM", opponent: "The Misfits", label: "vs The Misfits", rink: "North Rink", status: "upcoming", gameType: "Playoff" },
  ],
  lastGame: {
    opponent: "Saucer Kings",
    glizziesScore: 7,
    opponentScore: 1,
    date: "June 18, 2026",
    result: "win",
  ...
  seasonStats: {
    source: "Logged-in GameSheet and GameSheetStats team pages, verified June 19, 2026",
    gamesPlayed: 14,
    wins: 7,
    losses: 5,
    shootoutLosses: 2,
    ...
    matchup: {
    title: "Playoff Briefing: Misfit Problems",
    threatLevel: "Loose-Cannon Emergency",
    playerToWatch: "#5 Julia Mulhern",
    ...
    opponentStats: [
      "Latest completed game: Glizzies hammered Saucer Kings 7-1 on June 18 and outshot them 23-11.",
      "Updated Glizzies snapshot: 14 GP, 7 wins, 5 losses, 2 shootout losses, 16 points, 55 GF, 44 GA, +11.",
      "The Misfits standings row: 14 GP, 4 wins, 10 losses, 8 points, 35 GF, 55 GA, -20, Lost 3.",
      "Top visible Misfits scorers: Julia Mulhern 9 points, Angus Maclellan 9, Todd Margetts 8, David Breding 8.",
      "Logged-in GameSheet now confirms the June 11 result too, so the current playoff snapshot is fully verified.",
    ],
    keys: [
      "Bring the same first-period violence that buried Saucer Kings before they could settle in.",
      "Make The Misfits play 200 feet. Their row says minus-20 for a reason.",
      "Stay above Mulhern and Maclellan early so their touches feel expensive.",
      "Keep the forecheck dirty enough that every breakout starts with panic.",
      "Do not donate free momentum. Make them earn every inch of weirdness.",
    ],
  },
    opponentChirps: [
    {
      playerName: "Julia Mulhern",
      number: "5",
      moment: "Points Leader",
      lines: [
        "Nine points is cute. Now do it with someone stapled to your hands.",
        "Julia, if you want that ninth point to matter, you are going to need a lot more help than this standings row suggests.",
        "We saw the stat line. Congratulations on being the first name on the clipboard.",
      ],
    },
    {
      playerName: "Angus Maclellan",
      number: "3",
      moment: "Shared Billing",
      lines: [
        "Angus, tying for the team points lead on a four-win team is the most beer-league resume bullet imaginable.",
        "Four goals, five assists, and still trapped in a minus-20 neighborhood. Tough zip code.",
        "You can run the whole attack if you want. We were planning on making that annoying anyway.",
      ],
    },
    {
      playerName: "Todd Margetts",
      number: "22",
      moment: "Chaos Budget",
      lines: [
        "Five goals and six penalty minutes is an honest commitment to multitasking.",
        "Todd, if you are going to bring both offense and nonsense, at least label the box clearly.",
        "You are one bad whistle away from leading the team in stories instead of goals.",
      ],
    },
    {
      playerName: "David Breding",
      number: "92",
      moment: "Distributor",
      lines: [
        "Six assists says you enjoy sharing. We would like that habit to continue directly onto our tape.",
        "David, we respect a pass-first player. We also plan on greeting every first pass personally.",
        "If you are the setup guy, we are assigning a full-time inconvenience crew immediately.",
      ],
    },
    {
      playerName: "The Misfits Bench",
      number: "ALL",
      moment: "Current Trend",
      lines: [
        "Lost 3 is not a trend, it is a public service announcement.",
        "The Misfits have 35 goals for and 55 against. That is less a profile and more a warning label.",
        "If the game plan is 'make it weird,' honestly, at least that part tracks.",
      ],
    },
  ],
    players: [
    { name: "Andrew Herrin", number: "6", nameplate: "A. FROMAN", position: "Forward", photo: "", bio: "Abe Froman. Sausage King of Chicago. Do not ask how he got the reservation.", stats: { gp: 14, g: 1, a: 2, pts: 3, pim: 2 }, instagram: "", nickname: "Sausage King of Chicago" },
    { name: "Devon Woodside", number: "94", nameplate: "SAUCE DAWG", position: "Forward", photo: "", bio: "Goal scorer and penalty-box frequent-flyer program member.", stats: { gp: 12, g: 3, a: 1, pts: 4, pim: 6, gwg: 1 }, instagram: "", nickname: "Sauce Dawg" },
    { name: "Chris Call", number: "24", nameplate: "J. CHESTNUT", position: "Forward", photo: "", bio: "Quietly productive, loudly inconvenient for opponents.", stats: { gp: 14, g: 3, a: 5, pts: 8, pim: 4 }, instagram: "", nickname: "J. Chestnut" },
    { name: "Cole Embrey", number: "3", nameplate: "WURSTMEISTER", position: "Wing", photo: "", bio: "Three goals, five assists, two game-winners, and still fully comfortable causing a scene.", stats: { gp: 14, g: 3, a: 5, pts: 8, pim: 2, gwg: 2 }, instagram: "", nickname: "Wurstmeister" },
    { name: "Parker Strong", number: "17", nameplate: "SIR GLIZZINGTON III", position: "Forward", photo: "", bio: "Captain. Name checks out. Forecheck probably files taxes early.", stats: { gp: 14, g: 4, a: 1, pts: 5, pim: 0 }, instagram: "", nickname: "Sir Glizzington III" },
    ...
    { name: "James Pope", number: "9", nameplate: "JDAWG", position: "Forward", photo: "", bio: "Points by generosity. Very diplomatic stat line.", stats: { gp: 14, g: 1, a: 2, pts: 3, pim: 0 }, instagram: "", nickname: "JDawg" },
    { name: "Brian Coburn", number: "73", nameplate: "UNCLE GLIZZBURN", position: "Forward", photo: "", bio: "Alternate captain, one goal, two helpers, no penalty drama.", stats: { gp: 13, g: 1, a: 2, pts: 3, pim: 0 }, instagram: "", nickname: "Uncle Glizzburn" },
    { name: "Hayden Rathmell", number: "1", nameplate: "GLIZ GOD", position: "Forward", photo: "", bio: "Fourteen points, seven goals, seven assists. The spreadsheet is now openly nodding.", stats: { gp: 14, g: 7, a: 7, pts: 14, pim: 0 }, instagram: "", nickname: "Gliz God" },
    { name: "Rushton Hiltbrand", number: "11", nameplate: "MEAT SHIELD", position: "Goalie", photo: "", bio: "Fourteen starts, 41 goals against, a 3.32 GAA, and still appears willing to speak to defensemen.", stats: { gp: 14, g: 0, a: 0, pts: 0, pim: 0, ga: 41, gaa: "3.32", sv: ".839" }, instagram: "", nickname: "Meat Shield" },
    ...
    { name: "Brady Bessette", number: "26", nameplate: "DER WURST", position: "Forward", photo: "", bio: "Three goals, zero assists. Direct deposit only.", stats: { gp: 14, g: 3, a: 0, pts: 3, pim: 2 }, instagram: "", nickname: "Der Wurst" },
    ...
    { name: "Anthony Bailey", number: "15", nameplate: "THE QUIET GARNISH", position: "Forward", photo: "", bio: "Two assists, no penalties, teammate-friendly hockey.", stats: { gp: 9, g: 0, a: 2, pts: 2, pim: 0 }, instagram: "", nickname: "The Quiet Garnish" },
    { name: "Matt Zimmerman", number: "95", nameplate: "ZIMMY CASINO", position: "Forward", photo: "", bio: "Two goals against Saucer Kings and a four-point season line that keeps paying out.", stats: { gp: 12, g: 3, a: 1, pts: 4, pim: 0 }, instagram: "", nickname: "Zimmy Casino" },
    { name: "Wyatt McNeil", number: "7", nameplate: "GLIZZNASTY", position: "Forward", photo: "", bio: "Six goals in nine games and the kind of release that keeps making goalies do paperwork.", stats: { gp: 9, g: 6, a: 0, pts: 6, pim: 2, gwg: 2 }, instagram: "", nickname: "Glizznasty" },
    { name: "Matt Nelson", number: "70", nameplate: "NELLY DOG", position: "Forward", photo: "", bio: "Four games, zero mess. The score sheet remains calm.", stats: { gp: 4, g: 0, a: 0, pts: 0 }, instagram: "", nickname: "Nelly Dog" },
