...
window.siteContent = {
  ...
  seasonStats: {
    ...
    { name: "Devon Woodside", number: "94", nameplate: "SAUCE DAWG", position: "Forward", photo: "", bio: "Goal scorer, historically a penalty-box regular — still a clean sheet this Fall. A shorthanded goal against the Salties and an assist on GLIZZARD OF OZ's 2nd-period marker against the Devastators pushes him to 6 points through four games. The engine keeps running.", stats: { gp: 4, g: 3, a: 3, pts: 6, pim: 0 }, instagram: "", nickname: "Sauce Dawg" },
