...
window.siteContent = {
  ...
  schedule: [
    ...
    { date: "2026-09-10", displayDate: "Sep 10", time: "11:00 PM", opponent: "Steamers", label: "@ Steamers", rink: "South Rink", status: "final", result: "win", glizziesScore: 4, opponentScore: 3 },
  ...
  lastGame: {
    ...
    threeStars: [
      { name: "Hunter Stewart (GLIZZIN' STEW) — 2G + 1A (assist on the GWG), season total to 9G — team lead", star: 1 },
      { name: "Devin Bain (MEAT SHIELD) — 33 saves on 36 shots (.917 SV%) for the W3 grinder win", star: 2 },
      { name: "Kyle Ronchak — the sub who buried the game-winner at 03:47 of the third when it mattered most", star: 3 },
    ],
  },
    playerSpotlight: {
    name: "Devon Woodside",
  ...
  hypeMeter: {
    ...
    hypeApiKey: "utahglizzies-fall2026-week8-saltshakers",
    hypeStorageKey: "utah-glizzies-fall2026-week8-hype-clicks",
  },
  seasonStats: {
    source: "Fall 2026 season — 6-1-0 after a gritty 4-3 road win over the Steamers on September 10",
    season: "Fall 2026",
    gamesPlayed: 7,
    wins: 6,
    losses: 1,
    ...
    { name: "Parker Strong", number: "17", nameplate: "SIR GLIZZINGTON III", position: "Forward", photo: "", bio: "Back in the lineup and finding the net — first goal of the season in the 10-0 win over the Zombonis. Then picked up the primary helper on GLIZ GOD's first goal of the season against the Steamers at 11:48 of the first, setting up the deke tree of the year. Formally passed the Glizzies Own Goal Crown over to SAUCE DAWG at center ice on August 27. Two Fall 2026 penalties, killed both.", stats: { gp: 4, g: 1, a: 1, pts: 2, pim: 2 }, instagram: "", nickname: "Sir Glizzington III" },
    ...
    { name: "James Pope", number: "9", nameplate: "JDAWG", position: "Forward", photo: "", bio: "Points by generosity. Raw Dog of the Night against the Zombonis — one assist, a full shift of grease. Then buried the first ever competition goal of his life against the Whalers — unassisted, career-first, Raw Dog again. Followed it up with the primary helper on GLIZZIN' STEW's late 2nd-period tying goal vs the Steamers on September 10. The Pope has a scoring career AND a setup career now.", stats: { gp: 5, g: 1, a: 2, pts: 3, pim: 0 }, instagram: "", nickname: "JDawg" },
    ...
    { name: "Hayden Rathmell", number: "1", nameplate: "GLIZ GOD", position: "Forward (A)", photo: "", bio: "The spreadsheet has a personality now. Assistant captain for Fall 2026. Was quietly running the top line as pure setup man — four assists through three games, zero goals — then walked into the Steamers zone at 11:48 of the first on September 10, ran a deke tree so nasty the bench nearly cleared, and sniped his first goal of the season past the Steamers goalie. Top line center, top shelf grease. Raw Dog of the Night. The setup man is now the finisher too.", stats: { gp: 4, g: 1, a: 4, pts: 5, pim: 0 }, instagram: "", nickname: "Gliz God" },
    { name: "Devin Bain", number: "11", nameplate: "MEAT SHIELD", position: "Goalie", photo: "", bio: "New season, same sacred crease. 27-for-30 W over the Gnarwhalers, 12-for-12 shutout of the Zombonis, .958 SV% vs the Devastators, 13-for-13 SHUTOUT of the Whalers plus a scoring assist. Then the grinder: took 36 shots against the Steamers on September 10 and stopped 33 of them (.917 SV%) for the win. Riding W3 into the Salt Shakers rematch.", stats: { gp: 5, g: 0, a: 1, pts: 1, pim: 0 }, instagram: "", nickname: "Meat Shield" },
    ...
    { name: "Joey Teahan", number: "69", nameplate: "WIENER WRANGLER", position: "Forward", photo: "", bio: "New for Fall 2026. Opened the scoring against the Whalers at 04:31 of the first for his first-Glizzy GWG. Picked up another roughing minor late in the 3rd against the Steamers — third roughing infraction in four games. The nameplate is not lying.", stats: { gp: 4, g: 1, a: 0, pts: 1, pim: 6 }, instagram: "", nickname: "Wiener Wrangler" },
    { name: "Hunter Stewart", number: "10", nameplate: "GLIZZIN' STEW", position: "Forward", photo: "", bio: "New for Fall 2026. Debut shutout in net, then dropped hat tricks and multi-goal games as a forward — including a hatty vs the Devastators with TWO shorties, and a two-goal 3rd in the Whalers shutout. Followed it up with another 2G night against the Steamers on September 10 PLUS the primary helper on Kyle Ronchak's GWG — a 3-point night that puts him at 9G on the season (team lead, T-league lead territory).", stats: { gp: 7, g: 9, a: 3, pts: 12, pim: 2 }, instagram: "", nickname: "Glizzin' Stew" },
  ],
  sponsors: {
    current: [
...
rawDogOfNight: {
    winner: "Hayden Rathmell",
    nameplate: "GLIZ GOD",
    gameNickname: "The Glizz God",
    number: "1",
    game: "@ Steamers — September 10, 2026",
    nominatedBy: "James Pope (JDAWG) — last week's Raw Dog of the Night",
    reason: "The setup man became the finisher. GLIZ GOD came into the game leading the team in assists (4) and having attempted approximately zero shots. Then at 11:48 of the first, he walked into the offensive zone, put on a set of dekes so nasty they scientifically registered on the Wasatch fault line, and actually shot the puck. Not just shot it — sniped it. Earth-moving. Dog-sizzling. Top line center, top shelf grease. The setup man decided he wanted a goal too, and the Steamers goalie could do nothing about it.",
    citation: "Official citation: GLIZ GOD #1 — aka The Glizz God — snapped his first goal of the season past the Steamers goalie at 11:48 of the first period on September 10, assisted by SIR GLIZZINGTON III. Four assists coming in, zero goals. Now: a goal to match, first of the season, delivered via a deke stack so filthy the bench nearly stood up. When the top line center — and the team's leading assist man — decides to shoot, opposing goalies pay the tax. Top shelf grease. Certified.",
    achievement: "1G — first of the season, earned by the deke tree of the year",
    honorableMention: "The Steamers goalie — no chance on that one; the dekes did all the work",
    stats: [
      { icon: "🎯", label: "First Goal of the Season" },
      { icon: "🕺", label: "Earth-Moving, Dog-Sizzling Dekes" },
      { icon: "🔝", label: "Top Line Center, Top Shelf Grease" },
    ],
  },
  gameStats: {
