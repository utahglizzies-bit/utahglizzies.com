...
window.siteContent = {
  ...
  lastGame: {
    ...
    threeStars: [
      ...
      { name: "Kaden Hess — 1G, 1A (incl. the GWG helper) in his Glizzies debut", star: 3 },
    ],
  },
    playerSpotlight: {
    name: "Devon Woodside",
  ...
  hypeMeter: {
    level: 0,
    label: "3-0 Hype",
    reason: "3-0-0 and rolling after a 10-0 shutout of the Zombonis. SAUCE DAWG ran the show with 3 points, MEAT SHIELD posted his first shutout of the season, and newcomer Kaden Hess scored in his Glizzies debut. Next up: the Salties at home. Every click gets the bench closer to full mustard pressure for game four.",
    gameWeek: "August 19 vs Salties",
    hypeGoal: 1000,
    hypeApiBase: "https://countapi.mileshilliard.com/api/v1",
    hypeApiKey: "utahglizzies-fall2026-week4-salties",
    hypeStorageKey: "utah-glizzies-fall2026-week4-hype-clicks",
  },
  seasonStats: {
    source: "Fall 2026 season — 3-0-0 after the August 13 shutout of the Zombonis",
    season: "Fall 2026",
    gamesPlayed: 3,
    wins: 3,
    losses: 0,
    ...
    matchup: {
    title: "Perfect Record, Fresh Test: Salties Visit",
    threatLevel: "Season-High Confidence",
    playerToWatch: "SAUCE DAWG — riding a 3-point game into week four",
    opponent: "Salties",
    record: "First meeting between these two this Fall 2026 season",
    storyline:
      "The Glizzies are 3-0-0 to open Fall 2026 after a 10-0 shutout of the Zombonis, with SAUCE DAWG (Devon Woodside) running the offense and MEAT SHIELD (Devin Bain) posting his first clean sheet of the year. Newcomer Kaden Hess picked up two points in his Glizzies debut. Next up is the Salties, a first-time opponent this season, at home on the South Rink August 19.",
    opponentBreakdown: [
      ["Last meeting", "First matchup between these two this Fall 2026 season."],
      ["Current form", "Glizzies are 3-0-0, outscoring opponents 19-3 through three games."],
      ["The showdown", "August 19, 8:45 PM, South Rink. Game four of eleven."],
    ],
    opponentStats: [
      "Next game: August 19 at 8:45 PM on the South Rink at Utah Mammoth Ice Center.",
      "Glizzies record: 3-0-0, 19 goals for, 3 against.",
      "First meeting: no history yet against the Salties this season.",
      "Returning core: GLIZ GOD, GLIZZNASTY, SAUCE DAWG, MEAT SHIELD and the rest of the crew are rolling.",
    ],
    keys: [
      "Keep riding the hot hand — SAUCE DAWG has 3 points in the last game alone.",
      "Protect a three-game unbeaten streak against a first-time opponent with no scouting history.",
      "Keep feeding the new-look lineup touches; the newest Glizzies made an instant impact against the Zombonis.",
      "MEAT SHIELD just posted a shutout — keep the shot quality down in front of him.",
      "Four games into eleven. Keep the grill lit and the streak alive.",
    ],
  },
    opponentChirps: [
    {
    ...
    { name: "Devon Woodside", number: "94", nameplate: "SAUCE DAWG", position: "Forward", photo: "", bio: "Goal scorer, historically a penalty-box regular — clean sheet so far this Fall. A goal and two assists against the Zombonis pushed him to 4 points through two games played.", stats: { gp: 2, g: 2, a: 2, pts: 4, pim: 0 }, instagram: "", nickname: "Sauce Dawg" },
    ...
    { name: "Ian Penders", number: "5", nameplate: "LIL' SMOKIES", position: "Forward (A)", photo: "", bio: "A forecheck that keeps the rhythm section honest. Assistant captain for Fall 2026. A quiet night against the Zombonis after a hot 3-goal start, but the 10-0 final didn't need him to force anything.", stats: { gp: 3, g: 3, a: 0, pts: 3, pim: 0 }, instagram: "", nickname: "Lil' Smokies" },
    ...
    { name: "Zimmy Casino", number: "95", nameplate: "GLIZ-Z", position: "Forward", photo: "", bio: "Broke through against the Zombonis with a 2-goal night, including the game-winner just 12:45 into the first — first multi-goal game of the season.", stats: { gp: 3, g: 2, a: 0, pts: 2, pim: 2 }, instagram: "", nickname: "Gliz-Z" },
...
rawDogOfNight: {
    ...
    gameNickname: "JDawg",
    number: "9",
    game: "vs Zombonis — August 13, 2026",
    nominatedBy: "Wyatt McNeil (GLIZZNASTY) — last week's Raw Dog of the Night",
    reason: "JDAWG did the stuff that doesn't show up on highlight reels. One helper on the scoresheet, but a full night of puck battles won, lanes closed, and D-zone shifts that never turned into Zombonis chances. As greasy of a glizzy as it gets on D.",
    citation: "Official citation: JDAWG #9 played the game nobody claps for and everybody needs — won the puck battles, closed the lanes, and made sure a 10-0 night stayed that clean the whole way through. One assist on the stat sheet, a full shift of grease everywhere else.",
    achievement: "1A — the shutout game",
    honorableMention: "Whoever was covering the Zombonis' forecheck against him, hope they had a good excuse ready",
    stats: [
      { icon: "🧹", label: "Swept The D-Zone Clean" },
      { icon: "🥓", label: "Greasy On Every Shift" },
      { icon: "🔒", label: "Locked Down His Lane" },
    ],
  },
  gameStats: {
