...
window.siteContent = {
  ...
  lastGame: {
    ...
    result: "loss",
    recap:
      "The Glizzies dropped their first game of Fall 2026, falling 3-2 to the Salties at home on the South Rink in a game that came down to the final horn. The Salties struck first at 10:54 in the opening period, but GLIZ-Z (Zimmy Casino) answered right back with a filthy dangle and a top-shelf snipe with under three minutes left in the first — assisted by newcomer MICRO GLIZZ (Derek Schlenker) for his first point as a Glizzy — tying it 1-1 after twenty. Neither team found the net in the second. The Salties pulled ahead in the third on goals from Alex Tschinkel and Cole Nagy's game-winner, before SAUCE DAWG (Devon Woodside) cut it to one with a shorthanded goal — his third of the season — with under a minute to play, but the Glizzies couldn't complete the comeback. GLIZZIN' STEW (Hunter Stewart) — back in net for this one — took the loss despite 24 saves on 27 shots. LIL' SMOKIES (Ian Penders) had a rough third period, taking three straight penalty minors. GLIZ-Z earned Raw Dog of the Night honors for the highlight-reel snipe that kept the Glizzies in it all night. Glizzies fall to 3-1-0 on the season, their first loss of the Fall.",
    momentOfGame:
      "GLIZ-Z (Zimmy Casino) undressing the Salties defense for a highlight-reel dangle and top-shelf snipe with under three minutes left in the first — the goal that tied it 1-1 and set up a game that came down to the final horn.",
    threeStars: [
      { name: "Zimmy Casino (GLIZ-Z) — 1G, the dangle and top-shelf snipe of the night, tied it up in the first", star: 1 },
      { name: "Devon Woodside (SAUCE DAWG) — shorthanded goal in the third, his 3rd of the season", star: 2 },
      { name: "Hunter Stewart (GLIZZIN' STEW) — 24 saves on 27 shots in the loss", star: 3 },
    ],
  },
    playerSpotlight: {
    name: "Devon Woodside",
  ...
  hypeMeter: {
    level: 0,
    label: "3-1 Bounce-Back Hype",
    reason: "First loss of the season — a 3-2 nail-biter to the Salties after GLIZ-Z's highlight-reel snipe tied it in the first. SAUCE DAWG's shorthanded goal in the third made it a one-goal game, but the Glizzies came up just short. Still 3-1-0 heading into the Devastators next. Every click gets the bench closer to a bounce-back win.",
    gameWeek: "August 27 vs Devastators",
    hypeGoal: 1000,
    hypeApiBase: "https://countapi.mileshilliard.com/api/v1",
    hypeApiKey: "utahglizzies-fall2026-week5-devastators",
    hypeStorageKey: "utah-glizzies-fall2026-week5-hype-clicks",
  },
  seasonStats: {
    source: "Fall 2026 season — 3-1-0 after a 3-2 loss to the Salties on August 19",
    season: "Fall 2026",
    gamesPlayed: 4,
    wins: 3,
    losses: 1,
    ...
    matchup: {
    title: "First Loss, Fast Reset: Devastators Visit",
    threatLevel: "Unknown Territory",
    playerToWatch: "GLIZ-Z — riding a highlight-reel snipe into week five",
    opponent: "Devastators",
    record: "First meeting between these two this Fall 2026 season",
    storyline:
      "The Glizzies dropped their first game of the season, 3-2 to the Salties, despite a highlight-reel tying goal from GLIZ-Z (Zimmy Casino) and a late shorthanded tally from SAUCE DAWG (Devon Woodside). At 3-1-0, they'll look to bounce back against the Devastators, a first-time opponent this season, at home on the South Rink August 27.",
    opponentBreakdown: [
      ["Last meeting", "First matchup between these two this Fall 2026 season."],
      ["Current form", "Glizzies are 3-1-0 after their first loss of the season, a 3-2 nail-biter to the Salties."],
      ["The showdown", "August 27, 10:00 PM, South Rink. Game five of eleven."],
    ],
    opponentStats: [
      "Next game: August 27 at 10:00 PM on the South Rink at Utah Mammoth Ice Center.",
      "Glizzies record: 3-1-0, 21 goals for, 6 against.",
      "First meeting: no history yet against the Devastators this season.",
      "Bounce-back mode: GLIZ-Z, SAUCE DAWG, and GLIZZIN' STEW look to answer after the first loss of the year.",
    ],
    keys: [
      "Bounce back — first loss of the season, first chance to answer it.",
      "Keep riding the hot hand — GLIZ-Z has back-to-back multi-point efforts, capped by the tying snipe against the Salties.",
      "Tighten up the third period — the Salties scored twice in the final frame to steal it.",
      "Stay out of the box — three penalties in the third against the Salties gave them room to work.",
      "Five games into eleven. Reset and get back on track.",
    ],
  },
    opponentChirps: [
    {
    ...
    { name: "Devon Woodside", number: "94", nameplate: "SAUCE DAWG", position: "Forward", photo: "", bio: "Goal scorer, historically a penalty-box regular — clean sheet so far this Fall. A shorthanded goal against the Salties in the third pushed him to 5 points through three games played.", stats: { gp: 3, g: 3, a: 2, pts: 5, pim: 0 }, instagram: "", nickname: "Sauce Dawg" },
    ...
    { name: "Parker Strong", number: "17", nameplate: "SIR GLIZZINGTON III", position: "Forward", photo: "", bio: "Back in the lineup and finding the net — first goal of the season in the 10-0 win over the Zombonis. The forecheck absolutely files taxes early.", stats: { gp: 2, g: 1, a: 0, pts: 1, pim: 0 }, instagram: "", nickname: "Sir Glizzington III" },
    ...
    { name: "Devin Bain", number: "11", nameplate: "MEAT SHIELD", position: "Goalie", photo: "", bio: "New season, same sacred crease. 27 saves on 30 shots for the win over the Gnarwhalers, then a clean 12-for-12 shutout against the Zombonis — his first blank sheet of the Fall.", stats: { gp: 2, g: 0, a: 0, pts: 0, pim: 0 }, instagram: "", nickname: "Meat Shield" },
    { name: "Kevin Peterson", number: "22", nameplate: "GLIZZ LORD", position: "Forward", photo: "", bio: "Clean record, useful points, suspiciously professional. An assist through two games, on GLIZZNASTY's last-second power-play goal against the Gnarwhalers.", stats: { gp: 2, g: 0, a: 1, pts: 1, pim: 0 }, instagram: "", nickname: "Glizz Lord" },
    { name: "Jared Aida", number: "8", nameplate: "GLIZZARD OF OZ", position: "Forward", photo: "", bio: "The hot dog cannon remains pointed at him. Wore the captain's letter in A. FROMAN's absence against the Zombonis and scored to boot.", stats: { gp: 2, g: 1, a: 1, pts: 2, pim: 0 }, instagram: "", nickname: "Glizzard of Oz" },
    { name: "Ian Penders", number: "5", nameplate: "LIL' SMOKIES", position: "Forward (A)", photo: "", bio: "A forecheck that keeps the rhythm section honest. Assistant captain for Fall 2026. A rough third period against the Salties — three straight penalty minors — but still 3 goals through four games this Fall.", stats: { gp: 4, g: 3, a: 0, pts: 3, pim: 6 }, instagram: "", nickname: "Lil' Smokies" },
    ...
    { name: "Zimmy Casino", number: "95", nameplate: "GLIZ-Z", position: "Forward", photo: "", bio: "The dangle and top-shelf snipe of the night against the Salties — his goal tied it 1-1 in the first and earned him Raw Dog of the Night. Third goal of the season.", stats: { gp: 4, g: 3, a: 0, pts: 3, pim: 2 }, instagram: "", nickname: "Gliz-Z" },
...
rawDogOfNight: {
    ...
    gameNickname: "Gliz-Z",
    number: "95",
    game: "vs Salties — August 19, 2026",
    nominatedBy: "James Pope (JDAWG) — last week's Raw Dog of the Night",
    reason: "GLIZ-Z answered the Salties' opening goal with a filthy dangle and a top-shelf snipe with under three minutes left in the first, tying the game 1-1 almost single-handedly. The kind of goal that gets the whole bench up on the boards.",
    citation: "Official citation: GLIZ-Z #95 took the puck, made a defender look silly, and buried it top shelf where mama hides the cookies — the exact kind of highlight-reel snipe that earns Raw Dog of the Night even on a night the boys came up just short.",
    achievement: "1G — the dangle and the snipe",
    honorableMention: "Salties goalie Justin Hatfield, hope he had a good angle on that one",
    stats: [
      { icon: "🎯", label: "Top Shelf, No Doubt" },
      { icon: "🕺", label: "Danged Right Through" },
      { icon: "🔥", label: "Tied It Up Solo" },
    ],
  },
  gameStats: {
