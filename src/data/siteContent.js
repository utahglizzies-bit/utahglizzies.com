window.siteContent = {
  ...
  lastGame: {
    ...
    threeStars: [
      { star: 1, name: "Trey Kemp", nameplate: "DAWGFATHER", number: "88", reason: "Buried an unreal one-timer on a Hayden feed while crashing the net. No hesitation, no committee meeting. Just finish." },
      { star: 2, name: "Hayden Rathmell", nameplate: "GLIZ GOD", number: "1", reason: "Threaded the perfect setup pass between two defenders. The goal does not happen without the sauce." },
      { star: 3, name: "Rushton Hiltbrand", nameplate: "MEAT SHIELD", number: "11", reason: "Held the Zombonis to 1. In playoff prep mode, a goalie who gives up one is a goalie the team can win behind." },
    ],
  },
  playerSpotlight: {
    name: "Trey Kemp",
