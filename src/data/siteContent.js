window.siteContent = {
  ...
  lastGame: {
    ...
    result: "win",
    recap:
      "Playoff hockey. Glizzies 5, Salt Shakers 2. The receipts from the May 14 regular season meeting were honored in full. The Glizzies came out with structure, jumped on the Salt Shakers early, and never gave them a window to believe this was a one-score game. Five goals, two allowed, and a trip to round two. The bench was loud. The bun was clean. Full mustard pressure delivered.",
    momentOfGame:
      "The fourth goal, which stretched the lead to three and officially ended the Salt Shakers' belief that they were in a hockey game.",
    threeStars: [
      { name: "J. Chestnut (J. CHESTNUT)", star: 1 },
      { name: "Hayden Rathmell (GLIZ GOD)", star: 2 },
  ...
  seasonStats: {
    ...
    matchup: {
    title: "Round Two Briefing: Go North, Win Anyway",
    threatLevel: "Elevated Condiment Pressure",
    playerToWatch: "TBD — scouting in progress",
    opponent: "The North",
    record: "The North: record pending GameSheet export",
    storyline:
      "The Glizzies punched their ticket to round two with a clean 5-2 demolition of the Salt Shakers. Now they head to North Rink to face The North — a team whose name already sounds like a final boss. The receipts from the regular season are being reviewed. The mustard is fresh. The bench has momentum and two days of rest. The North should be nervous.",
    opponentBreakdown: [
      ["Threat level", "TBD — full scouting report drops when GameSheet exports their stats. Until then: they made the playoffs, so assume they can skate."],
      ["Swing moment", "The first shift. Teams with momentum win first shifts. The Glizzies have won two straight and should not let The North think for even one minute that this is an even game."],
      ["Key danger", "Complacency. Five-two wins feel good until you treat the next opponent like the last one."],
    ],
    opponentStats: [
      "Next up: The North, June 11 at 10:45 PM on North Rink.",
      "Last result: Glizzies 5, Salt Shakers 2 — playoff round one complete.",
      "Season record: 6 wins, 5 losses, 1 OT loss, 13 points.",
      "Current streak: Won 2.",
    ],
    keys: [
      "Start fast. Two-straight wins means The North respects you. Make them feel it in the first two minutes.",
      "Protect the lead when you get it. No third-period charity.",
      "Keep J. Chestnut in the proper position. The pipe said no once. It will say no again.",
      "Trust the structure that beat Salt Shakers. Clean exits, net-front traffic, and short shifts.",
      "Win or go home. Preferably win. Again.",
    ],
  },
    opponentChirps: [
    {
      playerName: "The North",
      number: "00",
      moment: "Bold Name Choice",
      lines: [
        "You named yourselves The North. We named ourselves after a hot dog. One of us is eating tonight.",
        "The North sounds intimidating until you give up five goals in the playoffs.",
        "Bold to name your team The North when you are playing in Sandy, Utah, at 10:45 PM on a Thursday.",
      ],
    },
    {
      playerName: "The North",
      ...
      lines: [
        "Welcome to round two. We have been here before. You can tell because we brought snacks.",
        "The North showed up. The Glizzies brought receipts, mustard, and a scouting report that says you made it this far.",
        "Two rounds of playoff hockey and the Glizzies are still hungry. Literally and figuratively.",
      ],
    },
    {
      playerName: "The Bench",
      number: "—",
      moment: "General Intimidation",
      lines: [
        "We beat the Salt Shakers 5-2 last week. We are not bringing that energy down for anyone named after a compass direction.",
        "The North, The South, The East, The West — all roads lead to a Glizzies win on Thursday.",
        "Scouting report still loading. Chirps fully operational.",
      ],
    },
  ],
    players: [
  ...
  seasonArchive: [
    {
      ...
      topAssists: "Hayden Rathmell / Ian Penders — 5A each",
